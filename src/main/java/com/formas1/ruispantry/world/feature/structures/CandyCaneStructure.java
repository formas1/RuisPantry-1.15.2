...
public class CandyCaneStructure extends Structure<NoFeatureConfig>
{

	public CandyCaneStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
	{
		super(config);
	}
	...
	{
		return CandyCaneStructure.Start::new;
	}

	@Override
	public String getStructureName()
	{
		return RuisPantry.MOD_ID + ":candy_cane";
	}
	...
	public static class Start extends StructureStart
	{
				...
				Biome biomeIn)
		{
			...
			CandyCanePieces.start(templateManagerIn, generator, pos, rotation, this.components, this.rand);
