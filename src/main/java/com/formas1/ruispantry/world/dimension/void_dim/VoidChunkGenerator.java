...
public class VoidChunkGenerator extends NoiseChunkGenerator<VoidGenSettings> {
	...
	public VoidChunkGenerator(IWorld worldIn, BiomeProvider provider, VoidGenSettings settingsIn) {
