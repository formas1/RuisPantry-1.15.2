...
public class PantryChunkGenerator extends NoiseChunkGenerator<PantryGenSettings> {
	...
	public PantryChunkGenerator(IWorld worldIn, BiomeProvider provider, PantryGenSettings settingsIn) {
